                    ...
                    switch (usuarioActual.getTipo()) {
                        case TipoUsuario.ADMINISTRADOR:
                            ...
                            switch (menuAdmin.getEleccion()) {
                                case estados.actualizarTareas.OPCION_AGREGAR_USUARIO:
                                    estadoActual = EstadosApp.AGREGAR_USUARIO;
                                    break;
                                case estados.actualizarTareas.OPCION_CREAR_TAREA:
                                    estadoActual = EstadosApp.CREAR_TAREA;
                                    break;
                                case estados.actualizarTareas.OPCION_DESPLEGAR_TAREAS:
                                    estadoActual = EstadosApp.DESPLEGAR_TAREAS;
                                    break;
                                case estados.actualizarTareas.OPCION_FILTRAR_TAREAS:
                                    estadoActual = EstadosApp.FILTRAR_TAREAS;
                                    break;
                                case estados.actualizarTareas.OPCION_ACTUALIZAR_TAREAS:
                                    estadoActual = EstadosApp.ACTUALIZAR_TAREAS;
                                    break;
                                case estados.actualizarTareas.OPCION_ELIMINAR_TAREAS:
                                    estadoActual = EstadosApp.ELIMINAR_TAREAS;
                                    break;
                                case estados.actualizarTareas.OPCION_CERRAR_SESION:
